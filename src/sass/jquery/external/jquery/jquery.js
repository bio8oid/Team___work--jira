...
(function(global, factory) {
    ...
    jQuery.each({ focus: 'focusin', blur: 'focusout' }, function(orig, fix) {
      ...
      jQuery.event.special[fix] = {
        ...
        teardown: function() {
          ...
          var attaches = jQuery._data(doc, fix) - 1;
  ...
  function remove(elem, selector, keepData) {
    ...
    var elems = selector ? jQuery.filter(selector, elem) : elem;
  ...
  if (!support.opacity) {
    jQuery.cssHooks.opacity = {
      ...
      set: function(elem, value) {
        ...
        var opacity = jQuery.isNumeric(value)
  ...
  jQuery.cssHooks.marginLeft = addGetHookIf(support.reliableMarginLeft, function(
    elem,
    computed
  ) {
    if (computed) {
  ...
  function defaultPrefilter(elem, props, opts) {
    ...
    if (!jQuery.isEmptyObject(orig)) {
      ...
      (display === 'none' ? defaultDisplay(elem.nodeName) : display) === 'inline'
    ) {
  ...
  function addToPrefiltersOrTransports(structure) {
    ...
    return function(dataTypeExpression, func) {
      ...
      var dataTypes = dataTypeExpression.toLowerCase().match(rnotwhite) || [];
