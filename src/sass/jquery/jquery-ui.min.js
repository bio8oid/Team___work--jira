...
(function(t) {
  ...
  (t.cleanData = (function(e) {
    ...
    (t.Widget.prototype = {
      ...
      _off: function(e, i) {
        (i =
          (i || '').split(' ').join(this.eventNamespace + ' ') + this.eventNamespace),
          e.off(i).off(i),
    ...
    t.each({ show: 'fadeIn', hide: 'fadeOut' }, function(e, i) {
      t.Widget.prototype['_' + e] = function(s, n, o) {
        ...
        var r = n ? (n === !0 || typeof n === 'number' ? i : n.effect || i) : e;
        (n = n || {}),
  ...
  t(document).on('mouseup', function() {
    ...
    t.widget('ui.slider', t.ui.mouse, {
      ...
      _createHandles: function() {
        ...
        var n = this.element.find('.ui-slider-handle');

        var o = "<span tabindex='0'></span>";
      ...
      _calculateNewMax: function() {
        ...
        var e = this._valueMin();

        var i = this.options.step;

        var s = Math.round((t - e) / i) * i;
        (t = s + e),
      ...
      _refreshValue: function() {
        ...
        this._hasMultipleValues()
          ? this.handles.each(function(s) {
              (i =
                100 *
                ((l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin()))),
