...
!(function(e, t) {
    ...
    E.extend({
      ...
      isPlainObject: function(e) {
        ...
        return (
          ...
          (!(t = r(e)) ||
            ('function' == typeof (n = m.call(t, 'constructor') && t.constructor) &&
              a.call(n) === l))
        );
      },
      ...
      makeArray: function(e, t) {
        ...
        return (
          null != e &&
            (p(Object(e)) ? E.merge(n, 'string' == typeof e ? [e] : e) : u.call(n, e)),
          n
        );
      },
  ...
  var h = (function(n) {
    ...
    function se(t, e, n, r) {
      var i,
        ...
        d = e ? e.nodeType : 9;
      if (
        ((n = n || []), 'string' != typeof t || !t || (1 !== d && 9 !== d && 11 !== d))
      )
        return n;
    ...
    (se.uniqueSort = function(e) {
      var t,
        ...
        i = 0;
      if (
        ((l = !p.detectDuplicates), (u = !p.sortStable && e.slice(0)), e.sort(D), l)
      ) {
            ...
            if (n) {
              ...
              while ((e = e[u]))
                if (1 === e.nodeType || f)
                  if (
                    ((i =
                      (o = e[N] || (e[N] = {}))[e.uniqueID] || (o[e.uniqueID] = {})),
      ...
      function(r, i) {
        E.fn[r] = function(e, t) {
          ...
          return (
            ...
            1 < this.length && (P[r] || E.uniqueSort(n), O.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (E.fn.ready = function(e) {
    ...
    ('loading' !== v.readyState && !v.documentElement.doScroll)
      ...
      : (v.addEventListener('DOMContentLoaded', F), g.addEventListener('load', F));
  ...
  function ce(e, t) {
    for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++)
      (r = e[c]).style &&
        ...
        t
          ? ('none' === n &&
              ((l[c] = G.get(r, 'display') || null), l[c] || (r.style.display = '')),
            '' === r.style.display &&
              se(r) &&
              (l[c] = ((u = a = o = void 0),
              (a = (i = r).ownerDocument),
    ...
    special: {
      ...
      click: {
        ...
        _default: function(e) {
          var t = e.target;
          return (
            (fe.test(t.type) && t.click && S(t, 'input') && G.get(t, 'click')) ||
            S(t, 'a')
          );
        }
      },
  ...
  E.extend({
    ...
    clone: function(e, t, n) {
      var r,
        ...
        f = oe(e);
      if (
        !(b.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e))
      )
  ...
  function Fe(e, t, n) {
    ...
    return (
      (n = n || We(e)) &&
        ('' !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = E.style(e, t)),
        !b.pixelBoxStyles() &&
          Me.test(a) &&
          $e.test(t) &&
          ((r = s.width),
  ...
  function nt(e, t, n) {
    var r = We(e),
      i =
        (!b.boxSizingReliable() || n) && 'border-box' === E.css(e, 'boxSizing', !1, r),
      o = i,
      a = Fe(e, t, r),
        ...
        select: {
          ...
          set: function(e, t) {
            var n,
              ...
              a = i.length;
            while (a--)
              ((r = i[a]).selected = -1 < E.inArray(E.valHooks.option.get(r), o)) &&
                (n = !0);
  ...
  function mt(n, e, r, i) {
    ...
    if (Array.isArray(e))
      E.each(e, function(e, t) {
        r || ht.test(n)
          ? i(n, t)
          : mt(n + '[' + ('object' == typeof t && null != t ? e : '') + ']', t, r, i);
      });
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          t ||
            (b.createHTMLDocument
              ? (((r = (t = v.implementation.createHTMLDocument('')).createElement(
                  'base'
      ...
      E.fn[t] = function(e) {
        return z(
          ...
          function(e, t, n) {
            var r;
            if (
              (w(e) ? (r = e) : 9 === e.nodeType && (r = e.defaultView), void 0 === n)
            )
              return r ? r[i] : e[t];
